...
class DetalleEventoFragment : Fragment() {
    ...
    lateinit var usuarioCheck: UsersEventsResponse
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        builder.setTitle("Unirte a el evento")
            ...
            .setPositiveButton("Sí") { dialog, which ->
                ...
                if (isDentro) {
                    Snackbar.make(view, "Ya estas unido a este evento", Snackbar.LENGTH_SHORT)
                        .setBackgroundTint(
        ...
        call.enqueue(object : Callback<EventData> {
            override fun onResponse(call: Call<EventData>, response: Response<EventData>) {
                ...
                if (response.isSuccessful && body != null) {
                    view?.findViewById<TextView>(R.id.tvFechaEventoDetalleMainUsr)?.text =
                    ...
                    view?.findViewById<TextView>(R.id.tvSexoEventoDetalleMainUsr)?.text =
        ...
        call.enqueue(object : Callback<UsersEventsResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful && body != null) {
                    ...
                    isDentro = listEventos.contains(evento)
